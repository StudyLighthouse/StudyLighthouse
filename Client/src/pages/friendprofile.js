    ...
    <div className="bg-black text-white pt-2 rounded-lg w-screen h-screen flex flex-col">
      ...
      {userData && (
        <div className="w-full">
          <h2 className="lg:text-3xl text-sm md:text-xl font-bold text-left mb-4 ml-6 pt-4 italic">
            {userData.name}'s Profile
          </h2>
          <div className="flex items-center mb-10 ml-4">
            <img
              className="w-24 h-24 md:w-36 md:h-36 lg:w-48 lg:h-48 rounded-full"
              src={userData.profileImage || "https://placehold.co/100x100"}
              alt="Profile Image"
            />
            <div className="ml-4">
              <p className="text-blue-400 text-xs md:text-sm lg:text-lg">
                @{userData.name}
              </p>
          ...
          <div className="mb-4 pl-10 text-left space-y-4 flex flex-col justify-center text-sm md:text-lg lg:text-xl">
            ...
            <p>
              ...
              <a
                href={userData.newLinkedin}
                className="text-blue-600 ml-4 hover:underline"
              >
                {userData.newLinkedin}
              </a>
            </p>
          </div>
          <div className="flex-1">
            <h2 className="text-xl font-bold text-center m-8 underline">
              Solved Problems:
            </h2>
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 lg:gap-12">
              {userData.posted_solutions &&
              userData.posted_solutions.length > 0 ? (
