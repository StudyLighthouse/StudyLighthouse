        ...
        <div className="text-white">
            <nav className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                    ...
                    <div className="space-x-8 hidden md:flex">
                        <a href="/main" className="hover:text-zinc-300">About Us</a>
                        <a href="/speechgpt" className="hover:text-zinc-300">Features</a>
                        <a href="/textgpt" className="hover:text-zinc-300">Contact Us</a>
                    </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row justify-between pl-6 min-h-screen">
                <div className=" md:text-left md:w-1/2 space-y-4 intro-text ">
                    <h1 className="text-5xl md:text-7xl font-bold ml-4 shine">Adaptive Learning Companion</h1><br></br>
